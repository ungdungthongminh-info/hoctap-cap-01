    ...
    <Suspense fallback={<PageSkeleton />}>
      <Routes>
        ...
        <Route element={<AppLayout />}>
          ...
          <Route path="/curriculum"          element={<FeatureGuard requiredPlan="premium" title="Giao trinh nang cao dang bi khoa" description="Trang giao trinh mo rong va tuy chinh chi mo cho goi Premium."><CurriculumPage /></FeatureGuard>} />
