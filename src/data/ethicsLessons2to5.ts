...
export const ethicsLessons2: Lesson[] = [
  ...
  L2('u3','e2-08','Tiết kiệm thời gian','Biết sắp xếp TG hợp lý','Thời gian quý lắm! Học – chơi – nghỉ đúng lúc.','Dùng đồng hồ cát làm Trách nhiệm','easy',20),
  ...
  L2('u8','e2-17','Phòng tránh tai nạn','Nhận biết nguy hiểm, biết phòng tránh','Không nghịch điện, lửa, nước sâu. Tránh xa vật nguy hiểm.','Dạy SĐT khẩn cấp: 113-114-115','easy',20),
...
export const ethicsLessons3: Lesson[] = [
  ...
  L3('u9','e3-19','Yêu Tổ quốc','Tự hào là người Việt Nam','Tổ quốc VN: cờ đỏ sao vàng, quê hương tươi đẹp. Hát Quốc ca.','Kể cho con nghe về lịch sử VN','easy',25),
...
export const ethicsLessons4: Lesson[] = [
  ...
  L4('u3','e4-07','Yêu hòa bình','Giải quyết mâu thuẫn bằng đối thoại','Hòa bình = không đánh nhau, nói chuyện giải quyết. TG cần hòa bình.','Kể chuyện hòa bình','easy',25),
  L4('u4','e4-08','Bảo vệ di sản VH','Trân trọng di sản văn hóa dân tộc','Di sản: Hạ Long, phố cổ Hội An, nhã nhạc Huế... = tự hào VN.','Đưa con tham quan di sản','easy',25),
  L4('u4','e4-09','Phòng chống bạo lực','Nhận biết, phòng tránh bạo lực','Bạo lực = sai. Nói cho người lớn biết, gọi 111 (bảo vệ TE).','Dạy con SĐT 111','medium',25),
  L4('u5','e4-10','An toàn Internet','Bảo vệ bản thân trên MXH','Không gửi ảnh riêng tư, không gặp người lạ online, mật khẩu mạnh.','Kiểm tra hoạt động online con','medium',25),
  ...
  L4('u9','e4-19','Yêu nước','Làm việc tốt cho đất nước','Yêu nước = học giỏi, lao động tốt, bảo vệ quê hương.','Kể về anh hùng nhỏ tuổi VN','easy',25),
...
export const ethicsLessons5: Lesson[] = [
  ...
  L5('u2','e5-05','Tôn trọng ĐDVH','Tôn trọng văn hóa các dân tộc','54 dân tộc VN: mỗi dân tộc có trang phục, lễ hội, ngôn ngữ riêng.','Tham quan bảo tàng dân tộc học','easy',30),
  L5('u2','e5-06','Hòa bình và hữu nghị','Yêu chuộng hòa bình TG','Hòa bình = không chiến tranh. Hữu nghị = bạn bè quốc tế.','Kể về Liên Hợp Quốc','medium',30),
  ...
  L5('u8','e5-19','Tự hào dân tộc','Tự hào về truyền thống dân tộc VN','VN: 4000 năm lịch sử, Bách Việt, chiến thắng ngoại xâm, văn hóa đa dạng.','Kể chuyện Hai Bà Trưng, Quang Trung','easy',30),
  L5('u8','e5-20','Ôn tổng kết: Đạo đức 5','Ôn tập + tổng kết cấp I','Công dân-Pháp luật-Dân chủ-Nhân ái-Hòa bình-BV Trách nhiệm-Tự hào VN. Sẵn sàng lên lớp 6!','Khuyến khích con chia sẻ','easy',30),
];
