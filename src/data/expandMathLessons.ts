...
export const mathExpQuestions = [
  ...
  ...mathQ(3, 20037, 'easy', [['1 km = ? m', '', '1000', '1 km = 1000 m', 'do_luong'],['Quãng đường HN-hòa bình khoảng 100 km nghĩa là?', '["100.000 m","10.000 m","1.000 m"]', '100.000 m', '100 × 1000 = 100.000 m', 'do_luong'],['5 km = ? m', '', '5000', '5 × 1000 = 5000 m', 'do_luong']]),
