...
export const ethicsExpLessons = [
  ...
  LE(3,'DD3C5','L30_truyen_thong','Giữ gìn truyền thống','Biết về truyền thống Việt Nam','Tết, áo dài, phở, lễ hội','Tự hào truyền thống Việt!','easy',10,30),
  ...
  LE(4,'DD4C4','L27_lich_su_vn','Tự hào lịch sử Việt Nam','Yêu lịch sử dân tộc','Hùng Vương, Hai Bà Trưng...','Lịch sử hào hùng!','medium',10,27),
...
export const histgeoExpLessons = [
  ...
  LH(4,'LS4C3','L25_dia_hinh_vn','Địa hình Việt Nam','Núi, đồng bằng, biển','3/4 đồi núi, ĐB sông Hồng, Cửu Long','Việt Nam dài hình chữ S!','medium',12,25),
  ...
  LH(4,'LS4C5','L29_thanh_pho','Các thành phố lớn','Biết TP lớn Việt Nam','HN, TP.HCM, Đà Nẵng, Huế','Mỗi TP có nét riêng!','easy',10,29),
  LH(4,'LS4C5','L30_kinh_te_vn','Kinh tế Việt Nam đơn giản','Nông nghiệp, CN, DV','Lúa gạo, hải sản, may mặc','Việt Nam xuất khẩu gạo top thế giới!','medium',12,30),
  LH(4,'LS4C3','L31_bien_dao','Biển đảo Việt Nam','Biển Đông, quần đảo','Hoàng Sa, Trường Sa','Biển đảo thiêng liêng!','medium',12,31),
  LH(4,'LS4C4','L32_di_san_vn','Di sản thế giới tại Việt Nam','UNESCO công nhận','Vịnh Hạ Long, Hội An, Phong Nha','Di sản = tự hào!','easy',10,32),
  ...
  LH(5,'LS5C3','L25_chau_a','Châu Á — châu lục lớn nhất','Biết về châu Á','Trung Quốc, Nhật, Ấn Độ...','Việt Nam ở Đông Nam Á!','medium',12,25),
  ...
  LH(5,'LS5C5','L29_asean','ASEAN','Hiệp hội ĐNA','10 nước thành viên','Việt Nam là thành viên ASEAN!','medium',10,29),
  LH(5,'LS5C5','L30_vn_the_gioi','Việt Nam và thế giới','Việt Nam trong cộng đồng QT','Hợp tác quốc tế','Việt Nam mở cửa và hội nhập!','medium',10,30),
...
export const infoExpLessons = [
  ...
  LI(4,'TH4C4','L27_mang_xh','Mạng xã hội và em','An toàn trên mạng xã hội','Không chia sẻ vị trí, ảnh cá nhân','Hỏi bố mẹ trước khi đăng!','medium',12,27),
...
export const artExpLessons = [
  ...
  LA(3,'MT3C5','L29_kien_truc','Kiến trúc Việt Nam','Biết kiến trúc truyền thống','Đình, chùa, nhà rông','Kiến trúc Việt Nam rất đẹp!','easy',10,29),
  ...
  LA(5,'MT5C4','L32_lich_su_mt','Lịch sử mỹ thuật Việt Nam','Tranh sơn mài, lụa','Sơn mài Việt Nam nổi tiếng thời gian','Nghệ thuật Việt Nam tuyệt vời!','easy',10,32),
